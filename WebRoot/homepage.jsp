...
<head>
	...
	<script type="text/javascript">
		...
		function  getDate01(){
			...
			var myMinters = time.getMinutes();
			var mySeconds = time.getSeconds();
			var seconds = (60 - mySeconds) *1000;
			if(myDay < 10){
				myDay = "0" + myDay;
				}
			if(myMinters < 10){
                myMinters = "0" + myMinters;   
				}
			if(myHours < 10){
				myHours = "0" + myHours;   
				}
			...
			document.getElementById("day_day").innerHTML =  myHours + " 时  " + myMinters + " 分";
			//刷新时间
			setTimeout("getDate01()",seconds);
		}
		...
		function addfavorite(){
			var ua = navigator.userAgent.toLowerCase();
			 if (ua.indexOf("360se") > -1){
			  	...
			  	window.external.AddToFavoritesBar('${dynamicURL}/authority/loginInit.action','班主任管理系统');//IE8
			 }else if (document.all){
			  	window.external.addFavorite('${dynamicURL}/authority/loginInit.action','班主任管理系统');
			 }else{
	...
	// 			alert("父类节点无法点击哦...");
		...
		function loadMenu(resourceType, treeObj){
            ...
            {"accessPath":"house_list.html?page="+0,"checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"房源管理","resourceOrder":0,"resourceType":""},
...
<body onload="getDate01()">
			...
			<div id="top_op">
				<ul>
					<li>
						...
						<span>${sessionScope.teacher.teacher_name}</span>
					</li>
					<li>
    ...
    <div id="main">
      	<iframe name="right" id="rightMain" src="introduce.html" frameborder="0" scrolling="auto" width="100%" height="100%"></iframe>
    </div>
</body>
</html>
