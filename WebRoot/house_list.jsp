...
<body>
	<form id="submitForm" name="submitForm" action="" method="post">
		...
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							学号
							<input type="text" id="stu_num" name="stu_num" class="ui_input_txt02" />
							姓名
							<input type="text" id="stu_name" name="stu_name" class="ui_input_txt02" /> 
							状态
							<select name="stu_status" id="stu_status" class="ui_select01">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" value="查询" class="ui_input_btn01" onclick="javascript:search();" id="query1" /> 
			...
			<div class="ui_content">
				<div class="ui_tb">
					<table id="table_1" class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						<tr>
						...
						<c:forEach items="${list}" var="list">
							...
							<tr>
								<td><input type="checkbox" id="stu_id" name="IDCheck" value="${list.stu_id}" class="acb" /></td>
								<td>${list.stu_name}</td>
								<td>${list.stu_num }</td>
								<td>${list.stu_addr }</td>
								<td>${list.stu_position }</td>
								<td>${list.stu_remarks }</td>								
								<td>${list.stu_status }</td>
								<td>
									<a href="house_edit.html?stu_id=${list.stu_id}" class="edit">编辑</a> 
									<a href="javascript:del('${list.stu_id}');">删除</a>
								</td>
							</tr>
							</c:forEach>
				...
				<div class="ui_tb_h30">
					<div class="ui_flt" style="height: 30px; line-height: 30px;">
						共有
						<span class="ui_txt_bold04">${pagenum}</span>
						条记录，当前第
